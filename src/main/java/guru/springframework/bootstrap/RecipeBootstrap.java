...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    final CategoryReactiveRepository categoryReactiveRepository;
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.error("##########");
        log.error("UOM" + unitOfMeasureReactiveRepository.count().block().toString());
        log.error("UOM" + recipeReactiveRepository.count().block().toString());
        log.error("UOM" + categoryReactiveRepository.count().block().toString());
    }
